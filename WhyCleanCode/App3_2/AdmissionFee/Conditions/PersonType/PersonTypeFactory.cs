...
namespace App3_2.AdmissionFee.Conditions.PersonType
{
    ...
    {
        public static IPersonType Create(App3_2.PersonType personType)
        {
            switch (personType)
            {
                case App3_2.PersonType.老人:
                    return new 老人();
                case App3_2.PersonType.大人:
                    return new 大人();
                case App3_2.PersonType.学生:
                    return new 学生();
                case App3_2.PersonType.子供:
                    return new 子供();
                default:
                    //該当する入場者タイプが無い場合
